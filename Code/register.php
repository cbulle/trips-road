            ...
            <div class="formulaire">
                <div class="in_form">
                    <div class="toggle-box">
                        <button class="toggle-btn" id="btnLogin" onclick="window.location.href='login'">Se connecter</button>
                        <button class="toggle-btn active" id="btnRegister" onclick="window.location.href='register'">S'inscrire</button>
                    </div>
